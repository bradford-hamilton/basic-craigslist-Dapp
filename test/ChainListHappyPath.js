...
contract('ChainList', function(accounts) {
  ...
  var articleName1 = 'article_1';
  var articleDescription1 = 'Description for article_1';
  var articlePrice1 = 10;
  var articleName2 = 'article_2';
  var articleDescription2 = 'Description for article_2';
  ...
  it('should let us sell a first article', function() {
    return ChainList.deployed()
      ...
      .then(function(data) {
        assert.equal(data.length, 1, 'there now must be 1 article for sale');
  ...
  // test case: should let us sell a second article
  it('should let us sell a first article', function() {
    return ChainList.deployed()
      .then(function(instance) {
        chainListInstance = instance;
      ...
      .then(function(data) {
        assert.equal(data.length, 2, 'there now must be 2 article for sale');
